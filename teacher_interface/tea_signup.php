...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if ($usernameErr == "" AND $password1Err == "" AND $password2Err == "" AND $emailErr == ""){
        $sql = "INSERT INTO userdata (username,password, email,identity) VALUES ('$username','$password1','$email','teacher')";
...
<form style = "text-align: center" method="post" name = "post" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <input type="submit" name="signup" value="Sign up as teacher"> 
</form>

</body>
</html>

<form style = "text-align:center" method= "post" action = "../signin.php">
